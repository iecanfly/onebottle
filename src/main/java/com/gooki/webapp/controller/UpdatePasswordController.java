...
public class UpdatePasswordController extends BaseFormController {
    ...
    public ModelAndView showForm(@ModelAttribute("user") final User user,
            ...
            throws Exception
    {
        ...
        if (StringUtils.isEmpty(password)) {
            ...
            return showForm(null, username, null, request);
        }
        ...
        if (user != null) {
            ...
            if (usingToken) {
                ...
                if(errors != null) {
                    errors.rejectValue("password", "errors.invalid", new Object[]{getText("user.password", request.getLocale())},
                            "Password is invalid.");
                }
                return showForm(null, username, null, request);
            }
