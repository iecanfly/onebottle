...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.gooki.service.impl.PasswordTokenManager#generateRecoveryToken(com.gooki.model.User)
     */
    @Override
    ...
    /**
     * @see com.gooki.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.gooki.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.gooki.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
