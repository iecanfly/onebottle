...
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.gooki.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
    ...
    @Override
    public List<User> getSellersByAddress(Address address, int page) {
        return userDao.findSellersByAddress(address, page);
    }
}
