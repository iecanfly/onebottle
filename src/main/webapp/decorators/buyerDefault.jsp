...
<head>
    ...
    <script src="<c:url value='/scripts/buyerhome.js'/>" type="text/javascript"></script>
    <script src="<c:url value='/scripts/admin/bootstrap.min.js'/>" type="text/javascript"></script>
    <script src="<c:url value='/scripts/admin/AdminLTE/app.js'/>" type="text/javascript"></script>
    <script type="application/javascript">
        var ORDER_CANCEL_CONFIRM_MSG = '<fmt:message key="orders.cancel.confirm"/>';
        var ORDER_FORCE_CANCEL_CONFIRM_MSG = '<fmt:message key="orders.force.cancel.confirm"/>';
        var FAV_ORDER_DELETE_MSG = '<fmt:message key="buyer.fav.delete"/>';
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            ...
                            <p>
                                ${pageContext.request.remoteUser} - <fmt:message key="user.buyer"/>
    ...
    <aside class="left-side sidebar-offcanvas">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li>
                    <a href="<c:url value="/buyerHome"/>">
                        <i class="fa fa-tags"></i>
                        <span><fmt:message key="nav.buyer.order"/></span>
                    </a>
                </li>
                <li>
                    <a href="<c:url value="/buyerFavOrder"/>">
                        <i class="fa fa-heart-o"></i> <span><fmt:message key="nav.buyer.fav"/> </span>
                    </a>
                </li>
                <li>
                    <a href="<c:url value="/buyerOrderHistory"/>">
                        <i class="fa fa-clock-o"></i> <span><fmt:message key="nav.buyer.history"/> </span>
                    </a>
                </li>
            </ul>
        </section>
